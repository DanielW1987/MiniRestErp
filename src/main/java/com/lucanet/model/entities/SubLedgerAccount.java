...
@JacksonXmlRootElement(localName = "subLedgerAccount")
@NoArgsConstructor
@Getter
@ToString(includeFieldNames = false, of = {"number", "name"})
@ApiModel(value="Sub ledger account", description="Resource which represent a sub ledger account.")
public class SubLedgerAccount implements Identifiable {
  ...
  private String name;
  private String collectiveAccountNumber;
  private String type;
